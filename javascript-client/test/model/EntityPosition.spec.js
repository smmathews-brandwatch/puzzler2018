...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Puzzler2018.EntityPosition();
  });
  ...
  describe('EntityPosition', function() {
    it('should create an instance of EntityPosition', function() {
      // uncomment below and update the code to test EntityPosition
      //var instane = new Puzzler2018.EntityPosition();
      //expect(instance).to.be.a(Puzzler2018.EntityPosition);
    });
